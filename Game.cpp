...
// WINDOWS
// g++ main.cpp Game.cpp Actor.cpp Animation.cpp AssetManager.cpp Spaceship.cpp Projectile.cpp Position.cpp Enemy.cpp GameOver.cpp GamePause.cpp MainMenu.cpp Formation.cpp AliveObject.cpp -o AceCombat -IC:/SFML/include -LC:/SFML/lib -lsfml-graphics -lsfml-window -lsfml-system -lsfml-audio
// MAC
